...
class MunicipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipe" do
    assert_difference("Municipe.count") do
      post municipes_url, params: { municipe: { cns: @municipe.cns, cpf: @municipe.cpf, data_nascimento: @municipe.data_nascimento, email: @municipe.email, fot: @municipe.fot, nome_completo: @municipe.nome_completo, status: @municipe.status, telefone: @municipe.telefone } }
    end
  ...
  test "should update municipe" do
    patch municipe_url(@municipe), params: { municipe: { cns: @municipe.cns, cpf: @municipe.cpf, data_nascimento: @municipe.data_nascimento, email: @municipe.email, fot: @municipe.fot, nome_completo: @municipe.nome_completo, status: @municipe.status, telefone: @municipe.telefone } }
